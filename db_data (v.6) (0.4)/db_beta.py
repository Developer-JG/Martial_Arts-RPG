...
# NPC 클래스
class NPC:
    def __init__(self, name, liv, po_count, ag_count, ad_count, condition, drop_money, drop_exp):
        self.name = name
        self.liv = liv
...
# 아레나1 / 'Arena no.1 하북팽가'
NPC_01_01 = NPC("복호도 팽철영",,,,,1,,)
NPC_01_02 = NPC("웅풍도 팽대집",,,,,1,,)
NPC_01_03 = NPC("오호단문도 팽대회",,,,,1,,)
NPC_01_04 = NPC("진산도 팽대형",,,,,1,,)
NPC_01_05 = NPC("섬전신도 팽도엽",,,,,1,,)
# 아레나2 / 'Arena no.2 제갈세가'
NPC_02_01 = NPC("제갈영기",,,,,1,,)
NPC_02_02 = NPC("제갈명",,,,,1,,)
NPC_02_03 = NPC("제갈승",,,,,1,,)
NPC_02_04 = NPC("제갈선",,,,,1,,)
NPC_02_05 = NPC("제갈도",,,,,1,,)
# 아레나3 / 'Arena no.3 남궁세가'
NPC_03_01 = NPC("절옥검 남궁진",,,,,1,,)
NPC_03_02 = NPC("낙성군자 남군도",,,,,1,,)
NPC_03_03 = NPC("검패 남궁철",,,,,1,,)
NPC_03_04 = NPC("기협 남궁추",,,,,1,,)
NPC_03_05 = NPC("철검서생 남궁조",,,,,1,,)
# 아레나4 / 'Arena no.4 개방'
NPC_04_01 = NPC("혹랑 변혁",,,,,1,,)
NPC_04_02 = NPC("옥취개 송결",,,,,1,,)
NPC_04_03 = NPC("광권 종호",,,,,1,,)
NPC_04_04 = NPC("철심수사 모관",,,,,1,,)
NPC_04_05 = NPC("탈혼주개 손등",,,,,1,,)
...
'Arena no.8 무당파'
'Arena no.9 무림맹'
'Legendary Arena 소림사 (challenger)'
'Legendary Arena 소림사 (master)'
'Legendary Arena 소림사 (champion)'
